...
final class Assessment {
	 ...
	 * Nothing to register.
	 *
	 * All three of these were ways of getting the journey onto a WordPress
	 * page: a shortcode to embed it in post content, and two filters to offer a
	 * bare-canvas page template so the active theme did not wrap it in a
	 * sidebar. None of that exists here -- the journey is a route, served by
	 * public/index.php, which renders the canvas directly.
	 *
	 * render() below is unchanged and is what that route calls.
	 */
