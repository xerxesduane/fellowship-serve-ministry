...
Sixty-three tests covering the guarantees whose failure would be silent: the
...
Adding Composer and the WordPress PHPUnit scaffold to run sixty-three tests
